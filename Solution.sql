...
-- Number of rows DIRECTOR_MAPPING
SELECT COUNT(*) FROM DIRECTOR_MAPPING;

-- Number of rows GENRE 
SELECT COUNT(*) FROM GENRE ;

-- Number of rows MOVIE
SELECT COUNT(*) FROM  MOVIE;

-- Number of rows NAMES
SELECT COUNT(*) FROM  NAMES;

-- Number of rows RATINGS
SELECT COUNT(*) FROM  RATINGS;

-- Number of rows ROLE_MAPPING
...
SELECT Count(DISTINCT id) AS NumMov, year
FROM   movie
...
-- Action is with highest  112.88 seconds duration
...
SELECT Min(avg_rating)    AS MIN_AVG_RAT,
       Max(avg_rating)    AS MAX_AVG_RAT,
       Min(total_votes)   AS MIN_TOTAL_VOT,
       Max(total_votes)   AS MAX_TOTAL_VOT,
       Min(median_rating) AS MIN_MEDIAN_RAT,
       Max(median_rating) AS MAX_MEDIAN_RAT
FROM   ratings; 

   -- no outliers in the table
...
-- Movies of median rating of 7 is highest in number.
...
-- 24 Drama movies released in March 2017
